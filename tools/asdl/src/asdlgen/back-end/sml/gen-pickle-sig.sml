...
structure GenPickleSig : sig
    ...
    (* generate the signature for the pickler structure; the boolean is
     * true if there is any sharing in any of the picklers.
     *)
    ...
    fun gen anySharing (AST.Module{id, decls, ...}) = let
