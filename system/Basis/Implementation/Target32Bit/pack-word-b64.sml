 ...
 * All rights reserved.
 *
 * Implementation of PackWord64Big for 32-bit targets.
 *)
...
structure PackWord64Big : PACK_WORD =
  ...
  (* make a word32 from big-endian-order bytes [b1, b2, b3, b4] *)
    fun mkWord32 (b1, b2, b3, b4) =
	  W32.orb (W32.lshift(w8ToW32 b1, 0w24),
	  W32.orb (W32.lshift(w8ToW32 b2, 0w16),
	  W32.orb (W32.lshift(w8ToW32 b3,  0w8),
		          w8ToW32 b4)))
