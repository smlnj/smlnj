...
*@SMLalloc*='SIZE'::
  Specify the preferred size of the allocation area
...
*-s*'level'::
  ...
  The number of levels of the control hierarchy is controlled by 'level', with 0 printing
  just the root of the hierarchy.
