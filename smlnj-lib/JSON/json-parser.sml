                  ...
                  if (firstDigit = 0)
                    then (case next src
                       of (#".", src) => scanFrac(src, [])
                        | (#"e", src) => scanExp(src, [], [])
                        | (#"E", src) => scanExp(src, [], [])
                        | (#"0", _) => error' (src, InvalidNumber)
                        | (#"1", _) => error' (src, InvalidNumber)
                        | (#"2", _) => error' (src, InvalidNumber)
                        | (#"3", _) => error' (src, InvalidNumber)
                        | (#"4", _) => error' (src, InvalidNumber)
                        | (#"5", _) => error' (src, InvalidNumber)
                        | (#"6", _) => error' (src, InvalidNumber)
                        | (#"7", _) => error' (src, InvalidNumber)
                        | (#"8", _) => error' (src, InvalidNumber)
                        | (#"9", _) => error' (src, InvalidNumber)
                        | _ => (JSON.INT 0, src)
                      (* end case *))
