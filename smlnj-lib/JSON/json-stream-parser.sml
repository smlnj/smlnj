                  ...
                  if (first = 0)
                    then (case next startSrc
                       of (#".", src) => scanFrac(src, [])
                        | (#"e", src) => scanExp(src, [], [])
                        | (#"E", src) => scanExp(src, [], [])
                        | (#"0", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"1", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"2", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"3", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"4", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"5", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"6", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"7", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"8", _) => error' (ctx, startSrc, InvalidNumber)
                        | (#"9", _) => error' (ctx, startSrc, InvalidNumber)
