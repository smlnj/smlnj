...
structure JSONParser :> sig
  ...
  (* close a source *)
    ...
    type flags = {
        allowComments : bool,           (* Javascript comments *)
        allowTrailingCommas : bool,     (* trailing commas in arrays/objects *)
        allowHexNumbers : bool,         (* hexidecimal numbers *)
        allowExtendedFloats : bool,     (* *)
        allowExtendedStrings : bool     (* *)
      }

    val jsonFlags : flags
    val jsoncFlags : flags
    val json5Flags : flags
