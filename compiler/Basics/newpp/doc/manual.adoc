...
* `char : char -> format`
 ...
 char c : Formats c as #(string (toString c)).
...
* `hsequence : format -> format list -> format`
 ...
 hsequence sep fmts = sequence {alignment = H, sep = sep} fmts

* `psequence : format -> format list -> format`

 psequence sep fmts = sequence {alignment = P, sep = sep} fmts

* `vsequence : format -> format list -> format`

 vsequence sep fmts = sequence {alignment = V, sep = sep} fmts

* `csequence : format -> format list -> format`

 csequence sep fmts = sequence {alignment = C, sep = sep} fmts
