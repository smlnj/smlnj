...
datatype alignment  (* the alignment property of "aligned" blocks *)
  = H  (* Horizontal alignment, with implicit single space breaks (Space 1) between format components *)
  | P  (* Packed alignment, with implicit soft line breaks (Soft 1) between format components *)	
  | V  (* Vertical alignment, with implicit hard line breafks (Hard) between format components *)
