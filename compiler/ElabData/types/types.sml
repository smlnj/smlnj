...
type varSource = S.symbol * SM.region (* the "occurrence" of an overloaded identifier *)
type litSource = IntInf.int * SM.region (* the "occurrence" of an overloaded literal *)
