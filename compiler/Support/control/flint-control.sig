(* Admin/control/flint-control.sig
 *
 * COPYRIGHT (c) 2023 The Fellowship of SML/NJ (http://www.smlnj.org)
 * All rights reserved.
 *)

signature FLINT_CONTROL =
sig
  ...
  (* and extra int flag for random, temporary debugging *)
  val misc		: int ref

(* for use in FLINT/main/flintcomp.sml:
 *   val recover : (LambdaVar.lvar -> unit) ref
 *     -- to be moved elsewhere because of reference to LambdaVar, which is not available
 *        in Admin/control *) 

end (* signature FLINT_CONTROL *)
